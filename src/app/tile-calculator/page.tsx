            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {tileTypes.map((tile) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">{tile.size}</div>
                  <div className="text-sm text-gray-500">{tile.pricePerSqm.toLocaleString()}원/㎡</div>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <input
                ...
                onChange={(e) => setLaborCostPerSqm(e.target.value)}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold text-blue-800 mb-3">면적 계산</h4>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span>순 면적:</span>
                    <span className="font-semibold">{area.netArea.toFixed(1)}㎡</span>
                  </div>
                  <div className="flex justify-between">
                    <span>여유분:</span>
                    <span className="font-semibold">{area.wasteArea.toFixed(1)}㎡</span>
                  </div>
                  <div className="flex justify-between">
                    <span>필요 면적:</span>
                    <span className="font-semibold">{area.requiredArea.toFixed(1)}㎡</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-semibold text-green-800 mb-3">타일 개수</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>㎡당 타일:</span>
            ...
            <div className="mt-6 bg-yellow-50 p-4 rounded-lg">
              <h4 className="font-semibold text-yellow-800 mb-3">비용 계산</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>타일 비용:</span>
