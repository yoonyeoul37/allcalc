            ...
            <div className="flex-1 max-w-4xl">
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <a href="/muscle-mass-calculator" className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow hover:border-gray-300 cursor-pointer">
