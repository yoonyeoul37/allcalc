        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mb-12 text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Link href="/triangle-calculator" className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow hover:border-purple-300 cursor-pointer">
              ...
              <Link href="/engineering-calculator" className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow hover:border-red-300 cursor-pointer">
              ...
              <Link href="/random-number-generator" className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow hover:border-yellow-300 cursor-pointer">
