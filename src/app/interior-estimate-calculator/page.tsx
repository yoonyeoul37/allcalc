        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex justify-center items-center mb-4">
              <FaHome className="text-4xl text-gray-600 mr-3" />
          ...
          {/* 작업 선택 */}
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
            <h3 className="text-lg font-bold text-gray-800 mb-4">시공 작업 선택</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {interiorWorks.map((work) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-500">{work.pricePerSqm.toLocaleString()}원/㎡</div>
                  <div className="text-xs text-gray-400">{work.category}</div>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold text-blue-800 mb-3">면적 정보</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>바닥 면적:</span>
                    <span className="font-semibold">{area.floorArea.toFixed(1)}㎡</span>
                  </div>
                  <div className="flex justify-between">
                    <span>벽면적:</span>
                  ...
                  <div className="flex justify-between">
                    <span>천장 면적:</span>
                    <span className="font-semibold">{area.ceilingArea.toFixed(1)}㎡</span>
                  </div>
                  <div className="flex justify-between">
                    <span>총 면적:</span>
                    <span className="font-semibold">{area.totalArea.toFixed(1)}㎡</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-semibold text-green-800 mb-3">공간 정보</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>공간 종류:</span>
                  ...
                  <div className="flex justify-between">
                    <span>복잡도:</span>
                    <span className="font-semibold">{selectedRoom.complexity}x</span>
                  </div>
                  <div className="flex justify-between">
                    <span>선택 작업:</span>
                    <span className="font-semibold">{selectedWorks.length}개</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* 작업별 비용 */}
            {estimate.workCosts.length > 0 && (
              <div className="mt-6 bg-yellow-50 p-4 rounded-lg">
                <h4 className="font-semibold text-yellow-800 mb-3">작업별 비용</h4>
                <div className="space-y-2 text-sm">
            ...
            <div className="mt-6 bg-red-50 p-4 rounded-lg">
              <h4 className="font-semibold text-red-800 mb-3">총 견적</h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>공사비:</span>
                  <span className="font-semibold">{estimate.totalCost.toLocaleString()}원</span>
                </div>
                <div className="flex justify-between">
                  <span>설계비:</span>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <a href="/concrete-calculator" className="text-center p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow hover:border-blue-300 cursor-pointer">
                ...
                <p className="text-xs text-gray-600">부피 계산</p>
              </a>
              ...
              <a href="/tile-calculator" className="text-center p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow hover:border-purple-300 cursor-pointer">
