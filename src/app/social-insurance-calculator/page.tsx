            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>사업주 부담:</span>
                    <span className="font-semibold text-black">{calculateInsurance.employerShare.toLocaleString()}원</span>
                  </div>
                  <div className="flex justify-between">
                    <span>근로자 부담:</span>
                    <span className="font-semibold text-red-600">{calculateInsurance.employeeShare.toLocaleString()}원</span>
                  </div>
