          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="현재 환율을 입력하세요"
                    className="flex-1 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                  />
                  <a
                    href="/unit-converter"
                    className="px-4 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-center"
                  >
                    환율 계산기
                  </a>
                </div>
                {exchangeRate && (
                  <p className="text-xs text-gray-500 mt-1">
                    {selectedCurrency.symbol}1 = ₩{parseFloat(exchangeRate.replace(/[^\d.]/g, "") || "0").toLocaleString()}
                  </p>
                )}
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-black mb-3">수수료 계산</h3>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-black mb-3">송금 정보</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>송금 금액:</span>
                    <span className="font-semibold">{parseFloat(transferAmount.replace(/[^\d.]/g, "") || "0").toLocaleString()}원</span>
                  </div>
                  <div className="flex justify-between">
                    <span>총 송금 금액:</span>
                  ...
                  <div className="flex justify-between">
                    <span>수취인 받는 금액:</span>
                    <span className="font-semibold">{selectedCurrency.symbol}{calculateFees.receivedAmount.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>처리 시간:</span>
                    <span className="font-semibold">{selectedMethod.processingTime}</span>
                  </div>
                </div>
              </div>
            </div>
