          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-black mb-3">실수령액</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>연간 실수령액:</span>
                    <span className="font-semibold text-lg">{calculateWithholdingTax.netIncome.toLocaleString()}원</span>
                  </div>
                  <div className="flex justify-between">
                    <span>월 실수령액:</span>
                    <span className="font-semibold text-lg text-green-800">{calculateWithholdingTax.monthlyNetIncome.toLocaleString()}원</span>
                  </div>
                </div>
              </div>
            </div>
